export default function ViteLogo() {
    return (
        ...
        <div className="border border-blue-300/30 cursor-default w-fit rounded-md py-2.5 px-5 me-2 mb-2">
            <svg xmlns="http://www.w3.org/2000/svg" height="30px" viewBox="0 0 128 128">
               
                <path className="fill-blue-400/80 "
            ...
            <span className="text-blue-400/80">Vite</span>
