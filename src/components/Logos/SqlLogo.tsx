...
export default function SqlLogo() {
    return (

        <div className="border border-blue-300/30 cursor-default w-fit rounded-md py-2.5 px-5 me-2 mb-2">
            <svg className="fill-blue-400/80 " height="30px" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
            ...
            <span className="text-blue-400/80">SQL</span>
        </div>
    )
}